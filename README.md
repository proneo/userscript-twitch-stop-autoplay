...
- Works with common browsers via a userscript manager.
- Helps focus on the content you want to see.

## 💻 System Requirements
To use this UserScript, you need the following:
- A web browser that supports userscripts. Recommended browsers include:
  - Google Chrome
  - Mozilla Firefox
  - Microsoft Edge
...
4. **Configure the Script (Optional):**
   - Open your userscript manager and find "Twitch Stop Autoplay" in your list of scripts. You can customize settings as needed.

5. **Enjoy Browsing:**
   - Visit the Twitch homepage. You should no longer see videos auto-playing on your feed.
...
This Userscript modifies the behavior of the Twitch website so that videos do not start playing until you click play.

### Can I use it with other sites?
This UserScript is specifically designed for Twitch. However, you can look for similar scripts aimed at other websites.

### What if I encounter issues?
If you experience issues, consider:
- Disabling other userscripts that might conflict.
- Checking your browser's console for errors.

## 🚧 Troubleshooting
If you find that videos are still auto-playing, try the following:
- Ensure your userscript manager is enabled.
- Check for any updates to the UserScript.
